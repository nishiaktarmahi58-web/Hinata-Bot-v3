...
const mahmud = [
        "ভাৃ্ঁর্চুৃঁয়াৃ্ঁলৃ্ঁ এৃ্ঁরৃৃ্ঁ মৃ্ঁহাৃৃ্ঁরাৃ্ঁনিৃ্ঁ",
        "bby",
        "babu",
        "bbu",
        "jan",
...
module.exports = {
        ...
        onChat: async function ({ api, event, commandName }) {
                ...
                if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
                        ...
                        const randomReplies = [
                                "আদনান পেগনেট তোমরা কি জানো 🥺",
                                "আমাকে পটাই দেখা 😼",
                                "আমাকে ডাকলে ,আমি কিন্তূ কিস করে দেবো😘 ",                      
                                "আমার জামাইকে ইনবক্সে মেসেজ দাও Adnan Ahmed🤫😉 ",
                                ...
                                "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার আদনান বাবুর সালি, তুবা কে ও তো করতে পারো😑?",
                                ...
                                "কথা দেও আমাকে পটাবা...!! 😌",
                                "বার বার Disturb করেছিস কোনো, আমার জানু তুবা এর সাথে ব্যাস্ত আসি 😋",
